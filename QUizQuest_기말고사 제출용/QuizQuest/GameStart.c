...
Question questions[] = {
    ...
    /*questions는 Question 구조체를 담고 있는 배열입니다.각 배열 요소는 하나의 질문과 해당 질문의 정답을 저장합니다.*/
...
void playSphinxQuizGame()
{
    ...
    /*playSphinxQuizGame()에서 변수를 선언한 부분*/
    ...
    while (player_hp > 0 && sphinx_hp > 0) 
    {
        ...
        SetCursorPosition(103, 1);
        printf("Sphinx HP: %d", sphinx_hp);/*HP 표시*/
        printf("\033[0m");
